...
cp -R bin/Debug/net6.0/* $HOME/.nuget/plugins/netcore/CredentialProvider.Redirect/

echo install windows side
dotnet build -r win10-x64 --self-contained
...
cp -R bin/Debug/net6.0/win10-x64/* $USERPROFILE/.nuget/plugins/helpers/CredentialProvider.Redirect/
