...
cp -R bin/Debug/net10.0/* $HOME/.nuget/plugins/netcore/CredentialProvider.Redirect/
...
cp -R bin/Release/net10.0/win-x64/publish/* $USERPROFILE/.nuget/plugins/helpers/CredentialProvider.Redirect/
